...
/**
 * \file    test/phpunit/BillmysalesFunctionalTest.php
 * \ingroup billmysales
...
/**
 * Class BillmysalesFunctionalTest
 *
 ...
 *
 * @package Testbillmysales
 */
class BillmysalesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBillmysales')->click();
		} else {
			// Disable the module
			$this->byHref('modBillmysales')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/billmysales/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('billmysales/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/billmysales/admin/about.php');
		$this->authenticate();
		return $this->assertContains('billmysales/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('billmysaleswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBillmysales_BillmysalesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBillmysales_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
